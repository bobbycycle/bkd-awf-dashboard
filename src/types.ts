export type RuleAction = 'allow' | 'challenge' | 'block' | 'rate_limit'
export type ProtectionTier = 'CRITICAL' | 'HIGH' | 'MEDIUM' | 'CATCH_ALL'
export type AsnCategory = 'Residential' | 'Datacenter' | 'Tor' | 'Vpn' | 'Unknown'
...
export interface WafSettings {
  ...
  challenge_type: 'JS Challenge' | 'Proof of Work'
